...
<x-layout>
  <x-card class="p-10">
    ...
    <header>
      <h1 class="text-3xl text-center font-bold my-6 text-teal-900">
        Manage Artworks
      </h1>
            ...
            <tr class="border-gray-300">
              ...
              <td class="px-4 py-8 border-t border-b border-gray-300 text-lg">
                <x-card>
                  ...
                  <p class="text-teal-900 font-bold text-sm">
                    Original ID: {{ $artwork->id }}
                  </p>

                  @if ($artwork->original)
                    <div class="text-teal-900 text-sm">
                      <i class="text-green-900 fa-solid fa-check inline"></i>
                      <p class="inline text-teal-900 font-bold text-sm">
                        Original: Available
                      </p>
                  ...
                  @else
                    <div class="text-teal-900 text-sm">
                      ...
                      <p class="inline text-teal-900 font-bold">
                  ...
                  <div class="text-teal-900 text-sm">
                    ...
                    <a href="{{ url('pricings') }}" class="text-teal-900">
                      <p class="inline text-teal-900 font-bold text-sm">
                        Prints Available
                      </p>
                    </a>
