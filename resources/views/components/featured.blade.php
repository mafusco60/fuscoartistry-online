...
<section class="bg-cyan-50 px-4 pt-6 pb-10">
  <div class="container-xl lg:container m-auto">
    <h2 class="text-3xl font-bold text-cyan-900 mb-6 text-center">
      Featured Artworks
    </h2>
        ...
        >
          ...
          <div class="p-6">
            ...
            {{--
              ...
              class="absolute bottom-[25px] right-[15px] bg-cyan-900 hover:bg-cyan-800 text-white p-4 rounded-lg text-center text-sm w-2/3 md:w-1/3"
              >
              Details
              </a>
            --}}
