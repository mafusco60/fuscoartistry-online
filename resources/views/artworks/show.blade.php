<x-layout>
  <a
    ...
    class="text-teal-900 text-md my-4 py-2 px-8"
  >
  ...
  <div class="mx-4">
    <div class="text-lg inline text-rose-900 mb-4 rounded-xl py-2 px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-8 gap-6">
        ...
        <div
          class="grid grid-cols-1 md:col-span-3 px-5 pt-5 border border-gray-200 bg-teal-100 rounded-xl"
        >
          <h3 class="text-2xl text-center font-bold mt-10">
            "{{ $artwork->title }}"
          </h3>
          <h2 class="text-xl text-center text-teal-900 font-bold mb-10">
            {{ ucwords($artwork->medium) }}
          </h2>

          @if ($artwork->original)
            <h2 class="text-lg text-center text-teal-900">
            ...
            <h2 class="text-l text-center text-teal-900 mb-2">
        ...
        {{-- Row 1 - Cols 4-6 --}}
        <div
          class="grid grid-cols-1 md:col-span-3 px-5 pt-5 border border-gray-200 bg-teal-100 rounded-x mx-auto"
        >
          <a
        ...
        >
          ...
          <h2 class="text-lg text-teal-900 mt-4">
        ...
        {{-- Description --}}
        <div
          class="grid grid-cols-1 md:col-span-6 p-5 border border-gray-200 bg-teal-100"
        >
          <h2 class="text-2xl font-bold mb-4 mr-5 text-rose-900">
            Description
          </h2>
          <h3
            class="text-lg text-teal-900 space-y-6 font-normal text-justify"
          >
            {{ $artwork->description }}
          </h3>
        </div>
        ...
        <div class="grid grid-cols-1 md:col-span-8 gap-4 text-end">
          @guest
            @if (! Auth::guard('admin')->check())
              <a href="{{ route('login') }}">
                <p
                  class="bg-teal-100 text-teal-900 font-bold w-full py-2 px-4 rounded-full text-center"
                >
          ...
          @else
            ...
            >
              ...
              @if (auth()->user()->favorites()->where('artwork_id', $artwork->id)->exists())
                @method('DELETE')
                <button
                  class="bg-teal-100 hover:bg-rose-700 text-rose-900 hover:text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center"
                >
              ...
              @else
                <button
                  class="bg-teal-100 hover:bg-teal-600 hover:text-white text-rose-900 font-bold w-full py-2 px-4 rounded-full flex items-center justify-center"
                >
        ...
        @auth('admin')
          <div class="w-full grid grid-cols-1 md:col-span-8">
            ...
            >
              ...
              <button
                type="submit"
                class="px-4 py-2 bg-teal-100 text-rose-900 rounded-full font-semibold hover:bg-rose-700 hover:text-white w-full"
              >
          ...
          <div class="grid grid-cols-1 md:col-span-8 w-full">
            <a href="{{ route('artworks.edit', $artwork->id) }}">
              <button
                type="submit"
                class="bg-teal-100 text-rose-900 rounded-full font-semibold hover:bg-teal-700 hover:text-white w-full py-2 px-4 flex items-center justify-center"
              >
