...
<x-layout>
  <body>
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-3 bg-cyan-900 h-max">
        <div
        ...
        >
          ...
          ></div>
          <x-card>
            <h2 class="text-xl text-center text-cyan-800  font-bold">
              Admin Menu
            </h2>

            @if (Auth::guard('admin')->user() && Auth::guard('admin')->user()->status == 1)
              <p class="text-rose-500 text-md text-center">
                Hello {{ Auth::guard('admin')->user()->firstname }}!
              </p>
            @else
              <a href="{{ route('admin.authenticate') }}">
                <p class="text-rose-500 text-lg">Login Please</p>
              </a>
            @endif
          ...
          <div class="flex items-start w-[100%] flex-col mt-5">
            ...
            <ul>
              ...
              <li>
                ...
                >
                  <i class="fa-solid fa-archive pr-4 inline"></i>
                  Archived Listings
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  ...
                  class="flex text-white text-sm py-2 px-8 rounded-md hover:opacity-80"
                >
                  <i class="fa-solid fa-user-cog inline pr-4"></i>
                  Update Profile
                </a>
              </li>
