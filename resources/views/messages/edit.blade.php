  ...
  <body>
    ...
    >
      ...
      <div class="mb-3">
        ...
        <p class="text-cyan-800 inline">{{ $message->subject }}</p>
      </div>
      {{-- Message Body --}}
      <div class="mb-6">
      ...
      >
        ...
        <div class="mb-6 w-full">
          ...
          <div class="w-full p-4 border border-rose-500 text-cyan-700">
            <x-text-area
              id="reply"
              name="reply"
              {{-- value="{{ 'reply' }}" --}}
        ...
        <button
          type="submit"
          class="bg-cyan-500 text-white rounded py-2 px-4 hover:bg-rose-800 text-center w-full"
        >
          Submit Reply
        </button>
      </form>
