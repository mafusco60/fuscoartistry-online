<x-layout>
  <x-card>
    ...
    <header>
      <h1 class="text-xl text-center font-bold my-6 text-cyan-900">
        Archived Messages
      </h1>
    </header>
            ...
            <tr class="border-gray-300">
              ...
              <td class="px-4 py-8 border-t border-b border-gray-300 text-lg">
                <x-card>
                  ...
                  <div class="text-cyan-500 font-semibold text-sm">
                    <h1>
                  ...
                  <div class="text-sm">
                    <label
                      for="user-name"
                      class="inline-block text-sm font-semibold text-cyan-900"
                    >
                      Sender:
                    </label>

                    <p class="text-cyan-700 inline text-sm">
                    ...
                    <div>
                      <label
                        for="artwork_title"
                        class="text-sm font-semibold text-cyan-900"
                      >
                        Artwork:
                      </label>
                      <p class="text-cyan-700 inline text-sm">
                    ...
                    {{-- Subject --}}
                    <div>
                      <p class="text-cyan-900 font-semibold text-sm inline">
                        Subject:
                      </p>
                      <span class="text-cyan-700 inline text-sm">
                        {{ $archive_message->archive_subject }}
                      </span>
                    </div>
                    {{-- Message --}}
                    <div class="text-cyan-900 font-semibold text-sm inline">
                      <p class="text-cyan-900 inline text-sm">Message:</p>
                      <span class="font-normal mb-4 text-cyan-800 inline">
                        {{ $archive_message->archive_body }}
                      </span>
                    </div>
                    {{-- Reply Message - if exists --}}
                    <div class="text-cyan-900 font-semibold text-sm">
                      Reply Message:
                      @unless ($archive_message->archive_reply == null)
                        <span
                          class="font-normal text-sm text-cyan-800 inline"
                        >
                    ...
                    {{-- Filename --}}
                    <div class="text-xs text-cyan-800 font-bold">
                    ...
                    @unless ($archive_message->reply_creation_date == null)
                      <div class="text-cyan-900 text-xs font-bold">
